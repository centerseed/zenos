...
*2026-03-23 加入 Part 7.3 Dashboard 多 View 架構：同一份 ontology 的不同投影（專案/知識地圖/任務）。三欄佈局（Palantir 啟發）。UI 不出現 entity/ontology 用語。Dashboard 5 份 spec 合併為 dashboard-v1.md*
