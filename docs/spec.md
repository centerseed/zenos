...
│     未連結                     ██             5 entries       │
│                                                              │
│     特別重要：Firestore 裡的內容 = 從 AI 對話產出、           │
│     沒有存進任何檔案系統的知識。沒有 Storage Map，             │
│     用戶根本不知道這些知識存在。                                │
│                                                              │
│  它 不做：                                                    │
│  ✗ 文件編輯                                                   │
...
- [ ] Who 維度作為 ontology entry 權限過濾器的可行性
