...
**日期**：2026-03-23
**來源**：PM 與老闆討論後整理
**前置**：`docs/designs/TD-foundation-p0-entity-schema.md`（Entity Schema 擴展，**必須先完成**）、`docs/archive/specs/deferred-2026-03/SPEC-dashboard-v1.md`（完整規格）、`docs/decisions/ADR-005-dashboard-graph-library.md`（graph library）、`docs/decisions/ADR-006-entity-project-separation.md`（entity/project 分離）
...
**全部 schema 改動的詳細規格見 `docs/designs/TD-foundation-p0-entity-schema.md`。** Dashboard 實作依賴那份文件的任務 1 先完成。
...
- **`docs/designs/TD-foundation-p0-entity-schema.md`** — 基礎層 P0（**先做這個**）
- `docs/archive/specs/deferred-2026-03/SPEC-dashboard-v1.md` — 完整規格
