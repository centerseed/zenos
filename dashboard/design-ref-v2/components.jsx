...
const Icons = {
  ...
  wallet:  "M3 7h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h12v4M17 12h4",
  agent:   <><circle cx="12" cy="8" r="3" /><path d="M6 21v-2a4 4 0 014-4h4a4 4 0 014 4v2" /><path d="M9 8h.01M15 8h.01" /></>,
  ...
  return (
    <div style={{
      ...
      <aside style={{
        ...
        {/* Secondary nav · Settings / Team / Help */}
        <div style={{
          padding: "10px 0 10px", borderTop: `1px solid ${c.inkHair}`,
          display: "flex", flexDirection: "column", gap: 1,
        }}>
          {[
            { k: "team",     zh: "團隊",     en: "Team",     icon: Icons.users },
            { k: "agent",    zh: "Agent·MCP", en: "Agents",  icon: Icons.agent },
            { k: "settings", zh: "設定",     en: "Settings", icon: Icons.settings },
            { k: "help",     zh: "幫助",     en: "Help",     icon: "M9.1 9a3 3 0 015.8 1c0 2-3 3-3 3M12 17h.01" },
          ].map(it => {
            const active = activeNav === it.k;
            return (
              <button key={it.k} onClick={() => onNavChange?.(it.k)} style={{
                display: "grid", gridTemplateColumns: "18px 1fr auto",
                alignItems: "center", gap: 12,
                padding: "7px 10px",
                background: active ? c.surface : "transparent",
                ...
                <Icon d={it.icon} size={13} stroke={active ? 1.8 : 1.4} />
                <span style={{ fontSize: 12.5, fontWeight: active ? 500 : 400, letterSpacing: "0.04em" }}>
                  {it.zh}
                </span>
                <span style={{ fontFamily: fontMono, fontSize: 9, color: c.inkFaint, letterSpacing: "0.14em" }}>
                  {it.en}
                </span>
              </button>
            );
