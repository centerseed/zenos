...
// Ported 1:1 from design-ref/landing_c.jsx
"use client";
...
interface LandingCProps {
  t: ZenInkTokens;
}

export function LandingC({ t }: LandingCProps) {
    ...
    <div style={{ background: c.paper, color: c.ink, fontFamily: fontBody }}>
      ...
      >
        ...
        <div style={{ position: "relative", maxWidth: 960, margin: "0 auto" }}>
          ...
          >
            ZenOS 是以 Agent 為核心、以自然語言為介面的知識工作台。
            <br />
      ...
      <section
        style={{ padding: "120px 80px", borderBottom: `1px solid ${c.inkHair}` }}
      >
              ...
              >
                ...
                >
                  {g.ps.map((p, j) => (
                    ...
                    >
                      <span style={{ color: c.vermillion, marginRight: 6 }}>›</span>
                      {p}
                    </div>
                  ))}
                </div>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    flexDirection: "column",
                    gap: 8,
                    borderTop: `1px solid ${f.highlight ? "rgba(244,239,228,0.15)" : c.inkHair}`,
                    paddingTop: 16,
                  }}
                >
                  {f.bullets.map((b, j) => (
...
function TypewriterPrompt({ text, t }: { text: string; t: ZenInkTokens }) {
  ...
  return (
    <>
      ...
      <span
        style={{
          borderRight: `2px solid ${t.c.vermillion}`,
          marginLeft: 2,
          height: 18,
...
function LogLine({ t, kind, label, body, blinking }: LogLineProps) {
  const { c, fontMono, fontHead } = t;
  const color =
    kind === "user" ? c.ink : kind === "agent" ? c.vermillion : c.inkFaint;
    ...
    >
      ...
      >
        ...
        {blinking && (
          <span
            style={{
              borderRight: `2px solid ${c.vermillion}`,
              marginLeft: 4,
              display: "inline-block",
              height: 16,
              verticalAlign: "middle",
