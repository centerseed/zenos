...
// Ported 1:1 from design-ref/landing_b.jsx
"use client";
...
export function LandingB({ t }: LandingBProps) {
  ...
  return (
    <div style={{ background: c.paper, color: c.ink, fontFamily: fontBody }}>
      ...
      >
        <div>
          ...
          >
            ...
            <br />
            應該是
            <span style={{ color: c.vermillion }}>共同的資產</span>。
          </h1>
          <p
            style={{
              fontFamily: fontBody,
      ...
      {/* ── Metrics band ─────────────────────────── */}
      <section
        style={{ padding: "80px 80px", borderBottom: `1px solid ${c.inkHair}` }}
      >
        <div
          style={{
            maxWidth: 1200,
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            <svg viewBox="0 0 360 60" style={{ width: "100%", height: 60 }}>
              ...
              {[40, 120, 200, 280, 340].map((x, i) => (
                <g key={i}>
                  <circle
                    ...
                    cy="30"
                    r={i === 4 ? 3 : 5}
                    fill={i === 2 ? c.vermillion : c.ink}
                    opacity={i === 4 ? 0.5 : 1}
                  />
                  {i < 4 &&
                    [[x - 12, 14], [x + 12, 46], [x - 14, 48], [x + 14, 12]][i] && (
                      <line
                        x1={x}
                        y1="30"
                        x2={[x - 14, x + 14, x - 16, x + 16][i]}
                        y2={[14, 46, 48, 12][i]}
                        stroke={c.inkHair}
                        strokeWidth="0.5"
                      />
              ...
              {[
                [28, 14], [112, 48], [188, 48], [296, 12], [212, 14], [128, 14],
              ].map(([x, y], i) => (
                <circle
                  key={`sat-${i}`}
                  cx={x}
            ...
            <div style={{ order: f.reverse ? 2 : 1 }}>
              ...
              >
                {f.bullets.map((b, j) => (
                  ...
                  >
                    <span
                      style={{ width: 14, height: 1, background: c.vermillion }}
                    />
                    {b}
                  </div>
                ))}
              ...
              <a
                style={{
                  ...
                  textTransform: "uppercase",
                  cursor: "pointer",
                  borderBottom: `1px solid ${c.vermLine}`,
                  paddingBottom: 4,
                }}
              >
                了解更多 →
            ...
            {[
              {
                ...
                price: "待定",
                meta: "預計月費 · 親民",
                feats: ["個人知識地圖", "靜默 Agent · 標準", "節律儀表 · 個人"],
                cta: "Waitlist",
                highlight: false,
              },
              {
              ...
              >
                ...
                <div
                  style={{
                    borderTop: `1px solid ${p.highlight ? "rgba(244,239,228,0.15)" : c.inkHair}`,
                    paddingTop: 20,
                    marginBottom: 24,
                  }}
                >
...
// ── Hero product pane ────────────────────────────────────────────────────
function HeroProductPane({ t }: { t: ZenInkTokens }) {
