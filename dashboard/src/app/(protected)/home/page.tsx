...
// ZenOS · Home (Today) page — Zen Ink redesign
// Ported 1:1 from design-ref/page_home.jsx InkHomePage
// UI-only: no data fetching, demo data inline
      ...
      <div style={{ padding: "40px 48px 60px", maxWidth: 1600 }}>
        ...
        >
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: 10,
                    color:
                      p.tone === "accent" ? c.vermillion : c.inkFaint,
                    letterSpacing: "0.08em",
                  }}
                >
                  {p.due}
          ...
          >
            ...
            >
              本週有{" "}
              <span style={{ color: c.vermillion, fontWeight: 500 }}>
                3 項 P0 任務
              </span>{" "}
              待處理，其中 Acme 演示需今日完成。後端有兩個阻塞集中在 Value
              Validation 相關 ADR，建議優先處理。
            </p>
            <div style={{ flex: 1 }} />
            <div
              style={{
          ...
          >
            ...
            {[
              ...
              <div
                ...
                style={{
                  display: "grid",
                  gridTemplateColumns: "70px 3px 1fr",
                  gap: 14,
                  alignItems: "flex-start",
                  padding: "11px 0",
                  borderBottom:
                    i < 3 ? `1px solid ${c.inkHair}` : "none",
                }}
              >
                <div
                  style={{
                ...
                >
                  {b.t}
                  <br />
                  <span style={{ color: c.inkHair }}>{b.end}</span>
                </div>
                <div
                  style={{
                    width: 2,
