  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        <div className="rounded-lg border border-[#1F1F23] bg-[#0A0A0B] p-5">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <div className="mt-2 text-lg font-semibold text-white">
                Zentropy Main Quest Board PoC
              </div>
              <div className="mt-2 max-w-2xl text-sm text-[#A1A1AA]">
                把 Zentropy 的主體收斂成一個固定畫面：
                左邊丟進 `任務 / 想法 / 討論`，中間看 AI 怎麼讀局與給下一步，
                右邊直接看到它落到哪條主線、支線或分歧點。
              </div>
            </div>
            <Link
              href="/zentropy-world-poc.html"
              className="rounded-full border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-sm font-medium text-cyan-100 transition-colors hover:bg-cyan-400/20"
            >
              Open World Preview
            </Link>
          </div>
