...
mcp__zenos__confirm(
    ...
    id="task-id",
    accept=True,
    result="QA Verdict 摘要：所有 P0 通過，X 項測試全過"
)
...
| QA | PASS | `confirm(accept=True, result="QA 摘要")` |
| QA | FAIL | `confirm(accept=False, result="退回原因")` |
